...
The result is 40.8774825. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
Below is a table from a paper I'm currently working on. Without the analysis object in R, I have to create table myself.
 ...
 (Intercept)&4.95&1.00&5.37&\phantom{$>$}0.0209\\
 White-Poor (Z)&3.17&1.00&3.44&\phantom{$>$}0.0642&0.02\\
 Zero-Sum (Z)&17.96&1.00&19.48&$>$0.0001&0.03\\
 Education (Z)&0.39&1.00&0.42&\phantom{$>$}0.5161&0.00\\
 Income (Z)&0.16&1.00&0.17&\phantom{$>$}0.6817&0.00\\
 Democrat&9.60&1.00&10.42&\phantom{$>$}0.0013&0.02\\
 Black-Poor (Z)&1.92&1.00&2.08&\phantom{$>$}0.1496&0.00\\
 White-Poor (Z)xZero-Sum (Z)&7.96&1.00&8.63&\phantom{$>$}0.0034&0.01\\
 Residuals&506.92&550.00\\\hline
 \end{tabular} \label{ANOVA table}
 \caption{ANOVA table for Case Study 1.}
 \end{center}
 \end{table}
