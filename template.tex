...
The result is 41.1029994. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
\subsection{tables}
\noindent Below, we can load and take a peek at some data about the death rates per 1000 in Virgina in 1940 \citep{VADeaths}.
...
Below is a table from a paper I'm currently working on. Without the analysis object in R, I have to create table myself.
 ...
 & \multicolumn{2}{|c}{Control} & \multicolumn{2}{|c|}{L-Hyoscyamine} &
 \multicolumn{2}{|c|}{L-Hyoscine} & \multicolumn{2}{|c|}{R-Hyoscine}\\\hline
 Patient& \#Obs&HrsSleep& \#Obs&HrsSleep& \#Obs&HrsSleep& \#Obs&HrsSleep \\\hline
 ...
 10&9&29&5&4.9&5&6.3&6&6.4\\
 11&--&-- &2&6.3&2&6.8&2&7.3\\\hline
