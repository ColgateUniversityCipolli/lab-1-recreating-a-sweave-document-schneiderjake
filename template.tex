...
The result is 40.8248377. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
Below is a table from a paper I'm currently working on. Without the analysis object in R, I have to create table myself.
 ...
 White-Poor (\textit{Z})xZero-Sum (\textit{Z})&7.96&1.00&8.63&0.0034&0.01\\
